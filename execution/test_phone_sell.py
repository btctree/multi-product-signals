...
(_ROOT / "earmark").mkdir()
# every other /root default, repointed BEFORE any module reads it
os.environ["MPS_ALERT_DIR"] = str(_ROOT / "outbox")
os.environ["MPS_EXIT_ATTEMPTS"] = str(_ROOT / "exit_attempts.json")
os.environ["MPS_FX_LAST_GOOD"] = str(_ROOT / "fx_last_good.json")
os.environ["MPS_CONID_CACHE"] = str(_ROOT / "conid_cache.json")
os.environ["MPS_ORDERS_LEDGER"] = str(_ROOT / "orders_ledger.jsonl")
os.environ["MPS_OAUTH_DIR"] = str(_ROOT / "oauth")
